...
;; RETURNS: Rectangle with dimensions height * width
;; EXAMPLES: (rel-rec-sequence 10 4)=> Rectangle with width 10 and height 40
;; DESIGN STRATEGY: Domain Knowledge

(define ( rel-rec-sequence w p)
  (rectangle w (* w p) "outline" "blue")
  )

;;TESTS
(check-equal? (image-height (rel-rec-sequence 10 4)) 40 "Error:Expected Output is 40") 